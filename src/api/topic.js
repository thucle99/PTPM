...
export function getImageByTopic(idTopic) {
    return axios.get(`https://api.unsplash.com/topics/${idTopic}/photos?client_id=fuOu4odHIMZNCseveRF1qVtYgBE19N5Yt9ET01QehZk`);
  }
